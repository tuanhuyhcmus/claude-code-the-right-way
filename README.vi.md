...
Từ đó, việc chọn model phù hợp cho mỗi task trở thành một knob có chủ ý. Bạn có thể downshift sang model rẻ hơn, yếu hơn mà không lo nó đi chệch đường ray — vì đường ray là cấu trúc bạn build, không phải sự thông minh của model.
