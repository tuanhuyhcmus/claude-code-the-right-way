...
Khi dùng các solution có sẵn (Claude Code, Antigravity), mọi thứ đã bị che hết để end-user thấy như ma thuật vì Client xịn và model xịn. Cứ thử pair một client xịn với 1 model chưa xịn xem (vd các model <30B param) bạn sẽ thấy dù context có tốt đến đâu thì nó vẫn không hoạt động theo cách làm bạn hài lòng. Nhưng nó lại làm bạn thấy rõ vai trò của client và server rất rõ ràng. Điều đó sẽ giúp ích cho bạn sau này khi đổi client và model thì bạn biết bạn đang đánh đổi những thứ nào.
...
Đó không phải *best practice*, đó chỉ là kinh nghiệm cá nhân — không có gì là chân lý cả. **Đoạn ở trên vừa rồi mới là chân lý.** Có rất nhiều best practice khác, tuy nhiên sự khác biệt có thể là ở đây tôi giải thích vì sao tôi làm và vì sao nó lại chạy được với cách làm đó với những kiến thức nền tảng. Tôi nghĩ việc này sẽ giúp chúng ta khôn ngoan hơn trong việc lựa chọn các giải pháp có sẵn để sử dụng hơn là xem đây như 1 bộ giải pháp.
