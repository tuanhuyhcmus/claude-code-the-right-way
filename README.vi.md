...
Cú chuyển hướng mà repo này nhắm tới rất đơn giản: từ chỗ dùng một tool agentic như một user bình thường — lặng lẽ trầm trồ mỗi khi nó làm được gì đó khéo léo — sang chỗ dùng như một developer hiểu mechanics và chủ động điều khiển nó.
