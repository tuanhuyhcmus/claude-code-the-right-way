...
Repo này tồn tại vì đúng một lý do: **giúp bạn cho Claude đủ structure bền vững để những phần thông minh, khám phá của model rơi vào một chỗ có thể dự đoán được**, thay vì phải tự suy ra lại những fact cơ bản về codebase của bạn hết session này đến session khác.

Cú chuyển hướng mà repo này nhắm tới rất đơn giản: từ chỗ dùng một tool agentic như một user bình thường — lặng lẽ trầm trồ mỗi khi nó làm được gì đó khéo léo — sang chỗ dùng như một developer hiểu mechanics và chủ động điều khiển nó. Từ chỗ đó, chọn model phù hợp cho mỗi task trở thành một knob có chủ đích — bạn có thể downshift sang model rẻ hơn, yếu hơn mà không sợ mọi thứ đi chệch đường ray, vì đường ray là structure bạn đã dựng lên, không phải intelligence thô của model.
...
Gộp lại: window hữu hạn, mỗi token thêm vào làm loãng mọi token khác, và những kết luận mà session thông minh *suy ra* bị suy ra lại — không hoàn hảo — bởi session tiếp theo phải bắt đầu lại từ đầu. Miếng ghép còn thiếu là một chỗ để làm cho những kết luận đó **dính lại** — một chỗ `/compact` không viết lại được và session mới không thể không thấy. Đó chính xác là mục đích các primitive của Claude Code.
